...
public class PongSpriteLeft implements DisplayableSprite {
	...
	public PongSpriteLeft(double centerX, double centerY, double height, double width) {
	...
	public PongSpriteLeft(double centerX, double centerY) {
